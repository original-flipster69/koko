...
<img src="docs/mascot.svg" alt="koko" align="right" width="220">

![GitHub License](https://img.shields.io/github/license/original-flipster69/koko)
...
A security- and privacy-first sandboxed coding assistant for the terminal. `koko` connects to all your favorite LLM providers and provides least privilege access to your filesystem and shell. Nothing that you don't want to is leaving your machine.
